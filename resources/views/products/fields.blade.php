...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- Market Id Field -->
    <div class="form-group row ">
        {!! Form::label('Author', "Author",['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::select('market_id', $market, null, ['class' => 'select2 form-control']) !!}
            <div class="form-text text-muted">Insert Author</div>
        </div>
    </div>
    ...
    <div class="form-group row">
        {!! Form::label('file',"file", ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
