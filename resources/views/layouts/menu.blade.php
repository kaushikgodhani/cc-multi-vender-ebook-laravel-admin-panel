...
@can('markets.index')
    <li class="nav-item has-treeview {{ (Request::is('markets*') || Request::is('requestedMarkets*') || Request::is('galleries*') || Request::is('marketReviews*')) && !Request::is('marketsPayouts*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ (Request::is('markets*') || Request::is('requestedMarkets*') || Request::is('galleries*') || Request::is('marketReviews*')) && !Request::is('marketsPayouts*')? 'active' : '' }}"> @if($icons)
            ...
            <p>Author <i class="right fa fa-angle-left"></i>
            </p>
        </a>
            ...
            @can('markets.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('requestedMarkets*') ? 'active' : '' }}" href="{!! route('requestedMarkets.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-reorder"></i>@endif<p>Author Request</p></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('markets*') ? 'active' : '' }}" href="{!! route('markets.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-reorder"></i>@endif<p>Authors</p></a>
                </li>
            @endcan
            @can('galleries.index')
                <li class="nav-item">
            ...
            @can('marketReviews.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('marketReviews*') ? 'active' : '' }}" href="{!! route('marketReviews.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-comments"></i>@endif<p>Author Reviews </p></a>
                </li>
            @endcan
        </ul>
    </li>
...
@can('products.index')
    <li class="nav-item has-treeview {{ Request::is('products*') || Request::is('options*') || Request::is('optionGroups*') || Request::is('productReviews*') || Request::is('nutrition*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{  Request::is('products*') || Request::is('options*') || Request::is('optionGroups*') || Request::is('productReviews*') || Request::is('nutrition*') ? 'active' : '' }}"> @if($icons)
            ...
            <p>Books <i class="right fa fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
            @can('products.index')
            ...
            @can('productReviews.index')
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('productReviews*') ? 'active' : '' }}" href="{!! route('productReviews.index') !!}">@if($icons)
                            <i class="nav-icon fa fa-comments"></i>@endif<p>Book Reviews</p></a>
                </li>
            @endcan
...
@can('drivers.index')
    <li class="nav-item">
        <a class="nav-link {{ Request::is('drivers*') ? 'active' : '' }}" href="{!! route('drivers.index') !!}">@if($icons)<i class="nav-icon fa fa-buysellads"></i>@endif<p>Vendor </p></a>
    </li>
@endcan
...
@endcan
    ...
    {{-- <li class="nav-item has-treeview {{ Request::is('Campaigns*') ? 'menu-open' : '' }}">
        <a href="#" class="nav-link {{ Request::is('Campaigns*') ? 'active' : '' }}"> @if($icons)
                <i class="nav-icon fa fa-television"></i>@endif
            <p>CAMPAIGNS <i class="right fa fa-angle-left"></i>
            </p>
        </a>
        <ul class="nav nav-treeview">
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('Campaigns*') ? 'active' : '' }}" href="{!! route('Campaigns') !!}">@if($icons)
                            <i class="nav-icon fa fa-reorder"></i>@endif
                        <p>Campaigns</p></a>
                </li>
